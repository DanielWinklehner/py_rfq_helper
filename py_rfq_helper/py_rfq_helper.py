...
class RFQ(object):
    ...
    def import_field(self):
        ...
        addnewegrd(id=egrd,zs=0, ze=self._field._z_length)
    ...
    def create_vanes(self):
        ...
        rod1 = ZCylinder(self._vane_radius, length, zcent=zcent, xcent=self._vane_distance, voltage=10.*kV)
        rod2 = ZCylinder(self._vane_radius, length, zcent=zcent, xcent=-self._vane_distance, voltage=10.*kV) 
        rod3 = ZCylinder(self._vane_radius, length, zcent=zcent, ycent=self._vane_distance, voltage=-10.*kV)
        rod4 = ZCylinder(self._vane_radius, length, zcent=zcent, ycent=-self._vane_distance, voltage=-10.*kV)
